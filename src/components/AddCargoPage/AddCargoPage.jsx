...
class AddCargoPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            confirmDirty: false,
                    ...
                    <Layout>
                        <Header style={{background:'#f0f2f5', padding: 0,height:'100px'}}>
                            <h1 style={{fontSize:'50px',color:'rgba(14,144,155)',display:'block',marginTop:'20px'}}>
                                {localStorage.getItem('username')}欢迎回来！
                            </h1>
                        </Header>
                        <Content>
...
AddCargoPage = Form.create({})(AddCargoPage);
export default AddCargoPage;
